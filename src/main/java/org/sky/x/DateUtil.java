...
public class DateUtil {
	...
	/**
	 * @return date.getDay() 周 1 ： turn 1, 2 : return 0,
	 */
	...
	// snsoft.util.DateUtil.indexOfYearWeek
	...
	static public int getDaysOfMonth(int year, int month) {
		return (int) ((DateUtil.toLongTime(month == 12 ? (year + 1) : year,
				month == 12 ? 1 : (month + 1), 1) - DateUtil.toLongTime(year,
	...
	private static java.util.Date setDayEndTime(java.util.Date date) {
		if (date == null)
			return null;
